...
namespace Awesome.Net.Workflows
{
    public interface IWorkflowManager
    {
        ...
        Task<ActivityExecutionContext> CreateActivityExecutionContextAsync(ActivityRecord activityRecord, JObject properties);
        ...
        /// </summary>
        Task<IEnumerable<ActivityRecord>> ExecuteWorkflowAsync(WorkflowExecutionContext workflowContext, ActivityRecord activity);
    }
